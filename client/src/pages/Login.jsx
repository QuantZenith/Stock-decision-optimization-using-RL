...
const Login = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#FDF9F9] dark:bg-[#161212] flex flex-col relative overflow-hidden transition-colors duration-300">
      ...
      {/* Navbar Z-Index ensures it stays on top */}
      <div className="z-50 relative">
        <Navbar />
      </div>

      {/* Main Content - Flex-1 ensures it fills vertical space */}
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 relative z-10">
        
        {/* Background Decorations - Fixed to screen */}
        ...
        <div className="w-full max-w-md bg-white dark:bg-[#211A1A] rounded-3xl shadow-xl border border-landing-primary/10 p-8 md:p-10 backdrop-blur-sm relative animate-fade-in-up">
            ...
            <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-landing-surface dark:bg-black/20 border border-landing-primary/20 text-xs font-bold tracking-wider text-landing-primary uppercase mb-4">
                    <span className="w-2 h-2 rounded-full bg-landing-primary animate-pulse"></span>
                    Secure Login
                </div>
